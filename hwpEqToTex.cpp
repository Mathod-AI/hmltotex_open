...
wstring oneParameter[] = { L"\\sqrt",L"\\textrm",L"\\vec",L"\\vrm",L"\\ovr",L"\\overline",L"\\begintabu"
...
wstring funchwp[] = { L"sinh",L"cosh",L"tanh",L"sech",L"csch",L"cosech",L"coth"
    ...
    ,L"BULLET",L"bullet", L"AST",L"STAR",L"BIGCIRC",L"THEREFORE",L"BECAUSE",L"IDENTICAL",L"EXIST",L"DOTEQ",L"image",L"REIMAGE"
    ...
    ,L"UDARROW",L"RARROW",L"NWARROW",L"SEARROW",L"NEARROW",L"SWARROW", L"ARROW", L"arrow"
...
wstring funcTex[] = { L"\\sinh",L"\\cosh",L"\\tanh"
    ...
    ,L"\\max",L"\\min",L"\\textrm{arc}",L"\\arg",L"\\operatorname{Exp}",L"\\exp",L"\\det",L"\\gcd",L"\\bmod"
    ,L"\\textrm{if}",L"\\textrm{for}",L"\\textrm{and}",L"\\hom",L"\\ker",L"\\deg",L"\\dim",L"^{\\circ}"
    ...
    ,L"\\cdot",L"\\cdot", L"\\ast",L"\\star",L"\\bigcirc",L"\\therefore",L"\\because",L"identical",L"\\exists",L"\\doteq",L"\\fallingdotseq",L"\\risingdotseq"
    ...
    ,L"\\Updownarrow",L"\\Rightarrow",L"\\nwarrow",L"\\searrow",L"\\nearrow",L"\\swarrow", L"\\leftarrow", L"\\leftarrow"
    ,L"\\hookleftarrow",L"\\hookrightarrow",L"\\mapsto",L"\\Vert"

    ,L"\\cup",L"\\cap",L"\\cap",L"\\cup",L"\\varnothing",L"\\cdot",L"\\cdot"
...
wstring funcRemainNext[] = { L"\\textrm",L"\\begin{tabu}",L"\\mathcal{L}",L"^{\\circ}\\textrm{C}",L"{}^{\\circ}\\textrm{F}"
    ,L"$",L"$",L"{",L"{",L"}",L"}",L"(",L"(",L")",L")",L"[",L"[",L"]",L"]"
    ,L"\\",L"'",L"'",L"^",L"^",L"_",L"_"
    ,L"",L"\\\\",L"",L"",L"\n",L"\n" };
